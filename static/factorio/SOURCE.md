...
- `assembler/assembling-machine-3-sheet.png` (640x356, 32 frames of 80x89), `chest/steel-chest-24.png` (drawn 3x3 at Ben's call - 72x90 from the 64x80 sheet, a slight upscale), `inserter/fast-inserter-platform-24.png` (4 frames of 39x30), `belt/belt-tile-south-24.png` / `belt-tile-north-24.png` (the frame's own 64x64 tile centre), `silo/rocket-silo-24.png` (261x261 composite of the six static layers over the 216px footprint), `ground/ground-grass.jpg` (see below). Source sheets were staged in the session scratchpad only, never committed.
